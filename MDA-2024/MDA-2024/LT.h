...
#define LEX_CONDITION	 '?'	// is:, начало цикла/условной конструкции
...
#define LEX_VOID		 'p'	// ключевое слово процедуры
#define LEX_VAR			 'n'	// объявления переменных
#define LEX_MORE		 '>'	// проверка на больше
#define LEX_LESS		 '<'	// проверка на меньше
#define LEX_EQUALS		 '&'	// проверка на равенство
#define LEX_NOTEQUALS	 '!'	// проверка на не равно
#define LEX_MOREEQUALS	 '~'	// проверка на больше или равно
#define LEX_LESSEQUALS	 '@'	// проверка на меньше или равно
